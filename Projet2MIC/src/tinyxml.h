...
public:
	...
	TiXmlAttribute() : TiXmlBase(), document(0), next(0), prev(0), name(), value()
	{
	}

	#ifdef TIXML_USE_STL
	/// std::string constructor.
	TiXmlAttribute( const std::string& _name, const std::string& _value ) : document(0), prev(0), next(0), name(_name), value(_value)
	{
	}
	#endif

	/// Construct an attribute with a name and value.
	TiXmlAttribute( const char * _name, const char * _value ) : document(0), prev(0), next(0), name(_name), value(_value)
	{
		name = _name;
		value = _value;
		document = 0;
...
public:
	...
	*/
	...
	void SetAttribute( const std::string& name, unsigned long _value );
